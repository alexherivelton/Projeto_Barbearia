...
//        fila.adicionarClienteNaFila(new FilaDeEspera(servico.buscarPorId(2), c2, "14/11/25 - 15:30", StatusAtendimentoCliente.EM_ESPERA));
//        fila.adicionarClienteNaFila(new FilaDeEspera(servico.buscarPorId(3), c3, "14/11/25 - 16:30", StatusAtendimentoCliente.EM_ESPERA));

        fila.adicionarClienteNaFila(new FilaDeEspera(servico.buscarPorId(1), cliente.buscarCliente(2), "14/11/25 - 14:30", StatusAtendimentoCliente.EM_ESPERA ));
        fila.adicionarClienteNaFila(new FilaDeEspera(servico.buscarPorId(2), cliente.buscarCliente(3), "14/11/25 - 14:30", StatusAtendimentoCliente.EM_ESPERA ));
        fila.adicionarClienteNaFila(new FilaDeEspera(servico.buscarPorId(3), cliente.buscarCliente(4), "14/11/25 - 14:30", StatusAtendimentoCliente.EM_ESPERA ));
