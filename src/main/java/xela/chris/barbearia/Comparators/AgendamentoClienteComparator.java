...
public class AgendamentoClienteComparator implements Comparator<Agendamento> {
    @Override
    public int compare(Agendamento a1, Agendamento a2) {
        ...
        // Verifica se há pelo menos um serviço em cada lista
        ...
        // Compara pelo nome do primeiro serviço
